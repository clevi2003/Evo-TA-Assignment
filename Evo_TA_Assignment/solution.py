"""
solution.py: A solution class for assigning TAs.
...
class Solution:
    ...
    def __init__(self, ta_df, practicum_df):
        # grid of P, W, U for ta preference for each section
    ...
    def populate_assignments(self):
        """
        initializes assignment solution by assigning all preferred sections to all TAs
        """
        self.assignments = copy.deepcopy(self.preferences)
        self.assignments[self.assignments != "P"] = 0
        self.assignments[self.assignments == "P"] = 1
